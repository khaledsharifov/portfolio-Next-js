  ...
  return (
    <main className="max-w-[1166px]  m-auto px-[20px] relative">
      ...
      <div className="py-[60px] flex items-center gap-[40px] px-[20px]">
        <h1 className=" text-white text-[80px] font-[700] font-syne leading-[84px] w-[48%]">My mission is to make design easier.</h1>
        <p className="text-[#949494] text-[21px] font-sans leading-[39px] w-[45%]">
      ...
      <div className="flex justify-between gap-[20px] my-[40px] relative">
      ...
      <div className="pt-[80px] pb-[120px]">
        <h1 className="text-[48px] font-[700] font-syne text-white">Follow me on:</h1>
